/**
 * [carSCG(color)] returns the SVG element withe the color [color].
 * 
 * Note: This SVG is an open source element downloaded from 
 *       https://ionic.io/ionicons.
 */
export const carSVG = (color) => {

  return (`
    <svg xmlns="http://www.w3.org/2000/svg" class="modal--icon" viewBox="0 0 512 512">
      <path
        class="icon_path"
